...
void __attribute__ ((noinline)) i2c_wait(void) {
...
void __attribute__ ((noinline)) i2c_read_setup(uint8_t dev, uint8_t address)
{
...
void __attribute__ ((noinline)) i2c_write_byte(uint8_t dev, uint8_t address, uint8_t data)
{
