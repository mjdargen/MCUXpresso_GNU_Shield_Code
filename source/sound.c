...
void Play_Tone(void) {
//	int n, p;
	int i, d=MAX_DAC_CODE>>7, t, n;
	int p[12] = {813, 1150, 813, 813, 813, 1150, 813, 813, 813, 813, 1150, 1150};
	int c[12] = {800, 383,  800, 800, 800, 283,  800, 800, 800, 800,  283, 283};
